...
TRAIN_CPT_JSONL="${INPUT_JSONL:-${DATA_DIR}/cpt_corpus.v3.jsonl}"
TRAIN_SFT_PAIR_JSONL="${SFT_PAIR_JSONL:-${DATA_DIR}/sft_pairs.v3.jsonl}"
TRAIN_VAL_JSONL="${CPT_VAL_JSONL:-${DATA_DIR}/val_set.v3.jsonl}"
